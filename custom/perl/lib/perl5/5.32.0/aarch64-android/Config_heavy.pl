...
archlib='/data/perl/lib/perl5/5.32.0/aarch64-android'
...
ccdlflags='-Wl,-E'
ccflags='-I/system/include -D_LARGEFILE_SOURCE -D_FILE_OFFSET_BITS=64'
...
config_argc='13'
config_args='--target=aarch64-linux-android --targetarch=aarch64-unknown-linux-android -Dosname=android -Darchname=aarch64-android -Dsysroot=-I/system -Dprefix=/data/perl -Dsh=/system/bin/sh -Dcc=aarch64-linux-android-clang -Wl,-rpath=/data/perl/lib:/data/perl/lib/perl5/5.32.0/aarch64-android/CORE -Wl,--enable-new-dtags -Duseshrplib --keeplog --mode=target --target=aarch64-linux-android --targetarch=aarch64-unknown-linux-android'
contains='grep'
cp='cp'
cpio='cpio'
cpp='aarch64-linux-android-clang -Wl,-rpath=/data/perl/lib:/data/perl/lib/perl5/5.32.0/aarch64-android/CORE -Wl,--enable-new-dtags -E -P'
cpp_stuff='42'
cppccsymbols=''
cppflags='-I/system/include'
cpplast='-'
cppminus='-'
cpprun='aarch64-linux-android-clang -Wl,-rpath=/data/perl/lib:/data/perl/lib/perl5/5.32.0/aarch64-android/CORE -Wl,--enable-new-dtags -E -P'
cppstdin='aarch64-linux-android-clang -Wl,-rpath=/data/perl/lib:/data/perl/lib/perl5/5.32.0/aarch64-android/CORE -Wl,--enable-new-dtags -E -P'
cppsymbols=''
crypt_r_proto='0'
cryptlib=''
csh=''
...
installarchlib='/data/perl/lib/perl5/5.32.0/aarch64-android'
...
installprefix=''
installprefixexp=''
installprivlib='/data/perl/lib/perl5/5.32.0'
installscript='/data/perl/bin'
installsitearch='/data/perl/lib/perl5/site_perl/5.32.0/aarch64-android'
...
installsitelib='/data/perl/lib/perl5/site_perl/5.32.0'
...
ksh=''
ld='aarch64-linux-android-clang -Wl,-rpath=/data/perl/lib:/data/perl/lib/perl5/5.32.0/aarch64-android/CORE -Wl,--enable-new-dtags'
ld_can_script='define'
lddlflags='-I/system/include -shared'
ldflags='-I/system/include'
...
prefix='/data/perl'
prefixexp='/data/perl'
privlib='/data/perl/lib/perl5/5.32.0'
...
sig_size='35'
signal_t='void'
sitearch='/data/perl/lib/perl5/site_perl/5.32.0/aarch64-android'
...
sitelib='/data/perl/lib/perl5/site_perl/5.32.0'
...
ccflags_nolargefiles='-I/system/include -D_LARGEFILE_SOURCE -D_FILE_OFFSET_BITS=64'
ldflags_nolargefiles='-I/system/include'
